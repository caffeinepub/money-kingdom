    ...
    <nav className="fixed bottom-0 inset-x-0 z-50 bg-card border-t border-border shadow-lg">
      <div className="flex items-stretch h-14">
        {tabs.map((tab) => {
          ...
          return (
            <button
              ...
              className={`flex flex-col items-center justify-center gap-0.5 flex-1 transition-all duration-300 relative ${
                isActive
                  ? "text-primary"
            ...
            >
              ...
              <span
                className={`transition-transform duration-300 ${
                  isActive ? "tab-active-bounce" : ""
                }`}
                style={{
                  filter: isActive
                    ? "drop-shadow(0 0 4px oklch(0.62 0.09 66 / 0.8))"
                    : undefined,
                }}
              >
                <tab.icon
        ...
        >
          ...
          <span
            className={`transition-transform duration-300 ${
              activeTab === "profile" ? "tab-active-bounce" : ""
            }`}
            style={{
              filter:
                activeTab === "profile"
